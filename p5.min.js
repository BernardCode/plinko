/*! p5.js v0.7.1 August 10, 2018 */ ! function(a) {
    ...
    return function a(b, c, d) {
                            ...
                            for (var m, r, w, x, z, A, B, C, D, E, F, G, H = 0; H < c.length;) {
                                ...
                                switch (H += 1, I) {
                                    ...
                                    case 7:
                                        ...
                                        break;
                                    case 8:
                                        for (; p.length > 0;) g = u + p.shift(), h = v + p.shift(), i = g + p.shift(), j = h + p.shift(), u = i + p.shift(), v = j + p.shift(), o.curveTo(g, h, i, j, u, v);
                                        break;
                                    case 10:
        ...
        18: [function(a, b, c) {
            ...
            h.prototype.print = function() {
                ...
                var b;
                return "number" == typeof a ? (a !== this._pixelDensity && (this._pixelDensity = a, this._pixelsDirty = !0), b = this) : b = this._pixelDensity, this.resizeCanvas(this.width, this.height, !0), b
                    ...
                    window.DeviceOrientationEvent && (this._events.deviceorientation = null), window.DeviceMotionEvent && !window._isNodeWebkit && (this._events.devicemotion = null), this._start = function() {
                        ...
                        if (a) {
                            ...
                            for (var c in this._preloadMethods) {
                                ...
                                d !== e.prototype && d !== e || (this._isGlobal && (window[c] = this._wrapPreload(this, c)), d = this), this._registeredPreloadMethods[c] = d[c], d[c] = this._wrapPreload(d, c)
                            }
        ...
        27: [function(a, b, c) {
            ...
            d.Renderer2D = function(a, b, c) {
            ...
            }, d.Renderer2D.prototype.text = function(a, b, c, d, f) {
                var g, h, i, j, k, l, m, n, o, p, q = this._pInst,
                    r = Number.MAX_VALUE;
                if ((this._doFill || this._doStroke) && void 0 !== a) {
                    if ("string" != typeof a && (a = a.toString()), a = a.replace(/(\t)/g, "  "), g = a.split("\n"), void 0 !== d) {
                        ...
                        switch (this._rectMode === e.CENTER && (b -= d / 2, c -= f / 2), this.drawingContext.textAlign) {
                            case e.CENTER:
                                b += d / 2;
                                break;
                            case e.RIGHT:
                        ...
                        if (void 0 !== f) {
                            switch (this.drawingContext.textBaseline) {
                                ...
                                case e._CTX_MIDDLE:
                                    ...
                                    break;
                                case e.BASELINE:
                                    p = !0, this.drawingContext.textBaseline = e.TOP
                            }
                            r = c + f - q.textAscent()
                        }
                        ...
                        for (t === e.CENTER ? s = (g.length - 1) * q.textLeading() / 2 : t === e.BOTTOM && (s = (g.length - 1) * q.textLeading()), j = 0; j < g.length; j++) this._renderText(q, g[j], b, c - s, r), c += q.textLeading()
                    }
                    return p && (this.drawingContext.textBaseline = e.BASELINE), q
                }
                ...
                if (void 0 !== a) return a !== e.LEFT && a !== e.RIGHT && a !== e.CENTER || (this.drawingContext.textAlign = a), b !== e.TOP && b !== e.BOTTOM && b !== e.CENTER && b !== e.BASELINE || (b === e.CENTER ? this.drawingContext.textBaseline = e._CTX_MIDDLE : this.drawingContext.textBaseline = b), this._pInst;
                var c = this.drawingContext.textBaseline;
                return c === e._CTX_MIDDLE && (c = e.CENTER), {
                    horizontal: this.drawingContext.textAlign,
                    vertical: c
                }
            }, d.Renderer2D.prototype._applyTextProperties = function() {
                var a, b = this._pInst;
                return this._setProperty("_textAscent", null), this._setProperty("_textDescent", null), a = this._textFont, this._isOpenType() && (a = this._textFont.font.familyName, this._setProperty("_textStyle", this._textFont.font.styleName)), this.drawingContext.font = (this._textStyle || "normal") + " " + (this._textSize || 12) + "px " + (a || "sans-serif"), b
        ...
        32: [function(a, b, c) {
            ...
            d.prototype.beginContour = function() {
                ...
                if (d._validateParameters("bezierVertex", arguments), 0 === g.length) throw new Error("vertex() must be used once before calling bezierVertex()");
                i = !0;
                ...
                if (d._validateParameters("quadraticVertex", arguments), this._contourInited) {
                    var i = {};
                    return i.x = a, i.y = b, i.x3 = c, i.y3 = f, i.type = e.QUADRATIC, this._contourVertices.push(i), this
                }
                if (!(g.length > 0)) throw new Error("vertex() must be used once before calling quadraticVertex()");
                k = !0;
                for (var j = [], m = 0; m < arguments.length; m++) j[m] = arguments[m];
        ...
        34: [function(a, b, c) {
            ...
            d.prototype.noLoop = function() {
                ...
                if ("function" == typeof d) {
                    void 0 === c && this.scale(this._pixelDensity, this._pixelDensity);
                    for (var e = this, f = function(a) {
                            a.call(e)
                        }, g = 0; g < b; g++) this.resetMatrix(), this._renderer.isP3D && this._renderer._update(), this._setProperty("frameCount", this.frameCount + 1), this._registeredMethods.pre.forEach(f), d(), this._registeredMethods.post.forEach(f)
                }
            }, b.exports = d
        }, {
            "./main": 23
        ...
        39: [function(a, b, c) {
            ...
            e.prototype._hasMouseInteracted = !1, e.prototype.mouseX = 0, e.prototype.mouseY = 0, e.prototype.pmouseX = 0, e.prototype.pmouseY = 0, e.prototype.winMouseX = 0, e.prototype.winMouseY = 0, e.prototype.pwinMouseX = 0, e.prototype.pwinMouseY = 0, e.prototype.mouseButton = 0, e.prototype.mouseIsPressed = !1, e.prototype._updateNextMouseCoords = function(a) {
                ...
                var b = this._isGlobal ? window : this;
                this._setProperty("mouseIsPressed", !1), "function" == typeof b.mouseReleased ? !1 === b.mouseReleased(a) && a.preventDefault() : "function" == typeof b.touchEnded && !1 === b.touchEnded(a) && a.preventDefault()
        ...
        40: [function(a, b, c) {
            ...
            e.prototype.touches = [], e.prototype._updateTouchCoords = function(a) {
                if (null !== this._curElement) {
                    for (var b = [], c = 0; c < a.touches.length; c++) b[c] = d(this._curElement.elt, 
                        this.width, this.height, a, c);
                    this._setProperty("touches", b)
                }
            }, e.prototype._ontouchstart = function(a) {
                var b = this._isGlobal ? window : this;
                this._setProperty("mouseIsPressed", !0), this._updateTouchCoords(a), this._updateNextMouseCoords(a), "function" == typeof b.touchStarted ? !1 === b.touchStarted(a) && a.preventDefault() : "function" == typeof b.mousePressed && !1 === b.mousePressed(a) && a.preventDefault()
        ...
        46: [function(a, b, c) {
            ...
            a("../core/error_helpers"), i.prototype.loadJSON = function() {
                ...
                var l = new i.Table,
                    m = this;
                return this.httpDo(a, "GET", "text", function(a) {
                ...
                for (var a, b, c, d, f = {}, g = 0, h = "text/plain", i = arguments.length - 1; i > 0 && "function" == typeof arguments[i]; i--) g++;
                var k = arguments.length - g,
                    l = arguments[0];
                if (2 === k && "string" == typeof l && "object" == typeof arguments[1]) d = new Request(l, arguments[1]), b = arguments[2], c = arguments[3];
                else {
                    for (var m, n = "GET", o = 1; o < arguments.length; o++) {
                        var p = arguments[o];
                        if ("string" == typeof p) "GET" === p || "POST" === p || "PUT" === p || "DELETE" === p ? n = p : "json" === p || "jsonp" === p || "binary" === p || "arrayBuffer" === p || "xml" === p || "text" === p ? a = p : m = p;
                ...
                a || (a = -1 !== l.indexOf("json") ? "json" : -1 !== l.indexOf("xml") ? "xml" : "text");
                var r;
                return r = "jsonp" === a ? j(l, f) : fetch(d), r = r.then(function(b) {
                    if (!b.ok) {
                ...
                }), r.then(b || function() {}), r.catch(c || console.error), r
            ...
            y.Font = function(a) {
                ...
                if (!k) {
                    ...
                    this.font.forEachGlyph(a, b, c, d, e, function(a, b, c, d) {
                        ...
                        w: n - l,
                        advance: l - b
                    }, p = this._handleAlignment(f, g, a, k.x, k.y, k.w + k.advance), k.x = p.x, k.y = p.y, this.cache[x("textBounds", a, b, c, d, h, i)] = k
                }
                return k
        ...
        63: [function(a, b, c) {
            ...
            d.prototype.cylinder = function(a, b, c, e, g, h) {
                this._assert3d("cylinder"), d._validateParameters("cylinder", arguments), void 0 === a && (a = 50), void 0 === b && (b = a), void 0 === c && (c = 24), void 0 === e && (e = 1), void 0 === h && (h = !0), void 0 === g && (g = !0);
                ...
                if (!this.geometryInHash(j)) {
                    var k = function() {
                            this.vertices.push(new d.Vector(a, b, 0)), this.vertices.push(new d.Vector(c, e, 0)), this.vertices.push(new d.Vector(f, g, 0)), this.vertices.push(new d.Vector(h, i, 0)), this.uvs.push(0, 0, 1, 0, 1, 1, 0, 1), this.strokeIndices = [
                                [0, 1],
                                [1, 2],
                                [2, 3],
                                [3, 0]
                    ...
                    l.computeNormals()._makeTriangleEdges()._edgesToVertices(), l.faces = [
                        [0, 1, 2],
                        [2, 3, 0]
        ...
        64: [function(a, b, c) {
            ...
            d.prototype.camera = function() {
                return this._assert3d("camera"), d._validateParameters("camera", arguments), this._renderer.camera.apply(this._renderer, arguments), this
            }, d.RendererGL.prototype.camera = function(a, b, c, d, e, f, g, h, i) {
                void 0 === a && (a = this.defaultCameraX, b = this.defaultCameraY, c = this.defaultCameraZ, d = a, e = b, f = 0, g = 0, h = 1, i = 0), this.cameraX = a, this.cameraY = b, this.cameraZ = c;
                var j = a - d,
                    k = b - e,
                    l = c - f;
                this.eyeDist = Math.sqrt(j * j + k * k + l * l), 0 !== this.eyeDist && (j /= this.eyeDist, k /= this.eyeDist, l /= this.eyeDist);
                var m = g,
                    n = h,
                    o = i,
                    p = n * l - o * k,
                ...
                0 !== t && (m /= t, n /= t, o /= t), this.cameraMatrix.set(p, m, j, 0, q, n, k, 0, r, o, l, 0, 0, 0, 0, 1);
                var u = -a,
                    v = -b,
                    w = -c;
                return this.cameraMatrix.translate([u, v, w]), this.uMVMatrix.set(this.cameraMatrix.mat4[0], this.cameraMatrix.mat4[1], this.cameraMatrix.mat4[2], this.cameraMatrix.mat4[3], this.cameraMatrix.mat4[4], this.cameraMatrix.mat4[5], this.cameraMatrix.mat4[6], this.cameraMatrix.mat4[7], this.cameraMatrix.mat4[8], this.cameraMatrix.mat4[9], this.cameraMatrix.mat4[10], this.cameraMatrix.mat4[11], this.cameraMatrix.mat4[12], this.cameraMatrix.mat4[13], this.cameraMatrix.mat4[14], this.cameraMatrix.mat4[15]), this
            }, d.prototype.perspective = function() {
                return this._assert3d("perspective"), d._validateParameters("perspective", arguments), this._renderer.perspective.apply(this._renderer, arguments), this
            }, d.RendererGL.prototype.perspective = function(a, b, c, e) {
                void 0 === a && (a = this.defaultCameraFOV), void 0 === b && (b = this.defaultCameraAspect), void 0 === c && (c = this.defaultCameraNear), void 0 === e && (e = this.defaultCameraFar), this.cameraFOV = this._pInst._toRadians(a), this.cameraAspect = b, this.cameraNear = c, this.cameraFar = e, this.uPMatrix = d.Matrix.identity();
                var f = 1 / Math.tan(this.cameraFOV / 2),
                    g = 1 / (this.cameraNear - this.cameraFar);
                this.uPMatrix.set(f / b, 0, 0, 0, 0, -f, 0, 0, 0, 0, (e + c) * g, -1, 0, 0, 2 * e * c * g, 0), this._curCamera = "custom"
            }, d.prototype.ortho = function() {
                return this._assert3d("ortho"), d._validateParameters("ortho", arguments), this._renderer.ortho.apply(this._renderer, arguments), this
            }, d.RendererGL.prototype.ortho = function(a, b, c, e, f, g) {
                void 0 === a && (a = -this.width / 2), void 0 === b && (b = +this.width / 2), void 0 === c && (c = -this.height / 2), void 0 === e && (e = +this.height / 2), void 0 === f && (f = 0), void 0 === g && (g = Math.max(this.width, this.height));
                var h = b - a,
                    i = e - c,
                    j = g - f,
                    k = 2 / h,
                    ...
                    o = -(e + c) / i,
                    p = -(g + f) / j;
                this.uPMatrix = d.Matrix.identity(), this.uPMatrix.set(k, 0, 0, 0, 0, -l, 0, 0, 0, 0, m, 0, n, o, p, 1), this._curCamera = "custom"
            }, b.exports = d
        }, {
            "../core/main": 23
        }],
        65: [function(a, b, c) {
            ...
            d.prototype.orbitControl = function() {
                return this._assert3d("orbitControl"), d._validateParameters("orbitControl", arguments), this.mouseIsPressed && (this.rotateY((this.mouseX - this.width / 2) / (this.width / 2)), this.rotateX((this.mouseY - this.height / 2) / (this.width / 2))), this
            }, b.exports = d
        }, {
            "../core/main": 23
        }],
        ...
        68: [function(a, b, c) {
            ...
            a("./p5.Texture"), d.prototype.loadShader = function(a, b) {
                ...
                return this._assert3d("createShader"), d._validateParameters("createShader", arguments),
        ...
        71: [function(a, b, c) {
            ...
            d.RendererGL.prototype.beginShape = function(a) {
                ...
                return this.immediateMode.vertexColors.push(h[0], h[1], h[2], h[3]), this.immediateMode.uvCoords.push(e, f), this
                ...
                return this._doFill && this._drawFillImmediateMode(a, b, c, f, g, h), this.immediateMode.vertices.length = 0, this.immediateMode.vertexColors.length = 0, this.immediateMode.uvCoords.length = 0, this.isImmediateDrawing = !1, this
        ...
        73: [function(a, b, c) {
            ...
            d.RendererGL = function(a, b, c, e) {
                ...
                this.curStrokeColor = f._array, this.curStrokeShader.setUniform("uMaterialColor", this.curStrokeColor)
                ...
                var a = d.Renderer.prototype.push.apply(this),
                    b = a.properties;
                return b.uMVMatrix = this.uMVMatrix.copy(), b.cameraMatrix = this.cameraMatrix.copy(), a
                ...
                return this._defaultLightShader || (this.attributes.perPixelLighting ? this._defaultLightShader = new d.Shader(this, f.phongVert, f.phongFrag) : this._defaultLightShader = new d.Shader(this, f.lightVert, f.lightTextureFrag)), this._defaultLightShader
            }, d.RendererGL.prototype._getImmediateModeShader = function() {
                return this._defaultImmediateModeShader || (this._defaultImmediateModeShader = new d.Shader(this, f.immediateVert, f.vertexColorFrag)), this._defaultImmediateModeShader
            }, d.RendererGL.prototype._getNormalShader = function() {
                return this._defaultNormalShader || (this._defaultNormalShader = new d.Shader(this, f.normalVert, f.normalFrag)), this._defaultNormalShader
            }, d.RendererGL.prototype._getColorShader = function() {
                return this._defaultColorShader || (this._defaultColorShader = new d.Shader(this, f.normalVert, f.basicFrag)), this._defaultColorShader
            }, d.RendererGL.prototype._getLineShader = function() {
                return this._defaultLineShader || (this._defaultLineShader = new d.Shader(this, f.lineVert, f.lineFrag)), this._defaultLineShader
                ...
                return c || (c = new d.Texture(this, a), this.textures.push(c)), c
        ...
        74: [function(a, b, c) {
            ...
            d.Shader = function(a, b, c) {
                ...
                this.init(), this._bound || (this.useProgram(), this._bound = !0, this.bindTextures(), this._renderer._setDefaultCamera(), this._setMatrixUniforms(), this === this._renderer.curStrokeShader && this._setViewportUniform())
        ...
        75: [function(a, b, c) {
            ...
            d.Texture = function(a, b) {
                ...
                var a;
                return this.isSrcP5Image ? a = this.src.canvas : (this.isSrcMediaElement || this.isSrcP5Graphics || this.isSrcHTMLElement) && (a = this.src.elt), a
                ...
                if (0 !== a.width && 0 !== a.height) {
                    var b = this._getTextureDataFromSource(),
                        c = this._renderer.GL;
                    if (b.width !== this.width || b.height !== this.height) this.width = b.width, this.height = b.height, this.bindTexture(), c.texImage2D(this.glTarget, 0, this.glFormat, this.glFormat, c.UNSIGNED_BYTE, b), this.isSrcP5Image ? a.setModified(!1) : (this.isSrcMediaElement || this.isSrcHTMLElement) && a.setModified(!0);
                        ...
                        var d = !1;
                        a.isModified() ? (d = !0, a.setModified(!1)) : a.loadedmetadata && this._videoPrevUpdateTime !== a.time() && (this._videoPrevUpdateTime = a.time(), d = !0), d && (this.bindTexture(), c.texImage2D(this.glTarget, 0, this.glFormat, this.glFormat, c.UNSIGNED_BYTE, b))
