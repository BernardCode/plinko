 ...
 ! function(e) {
    ...
    return function() {
        ...
        1: [function(e, t, n) {
            ...
            ! function() {
                o._inertiaScale = 4,
                    o._nextCollidingGroupId = 1, o._nextNonCollidingGroupId = -1, o._nextCategory = 1, o.create = function(t) {
                        var n = {
                                id: a.nextId(),
                                type: "body",
                                label: "Body",
        ...
        2: [function(e, t, n) {
            ...
            ! function() {
                o.create = function(e) {
                    ...
                    if (-1 !== i && (o.removeCompositeAt(e, i), o.setModified(e, !0, !0, !1)), n)
                    ...
                    if (-1 !== i && (o.removeBodyAt(e, i), o.setModified(e, !0, !0, !1)), n)
        ...
        10: [function(e, t, n) {
            ...
            ! function() {
                o._restingThresh = 4, o._restingThreshTangent = 6, o._positionDampen = .9, o._positionWarming = .8, o._frictionNormalMultiplier = 5, o.preSolvePosition = function(e) {
                    ...
                    var n, i, s, a, l, c, d, u, p, f = r._temp[0],
                        m = r._temp[1],
                        v = r._temp[2],
                        y = r._temp[3];
                    ...
                    var t, n, o, i, s, a, l, c, d, u, p, f, m, v, y = r._temp[0],
                        g = r._temp[1];
                    for (t = 0; t < e.length; t++)
                        if (o = e[t], o.isActive && !o.isSensor)
                            for (i = o.activeContacts, s = o.collision, a = s.parentA, l = s.parentB, c = s.normal, d = s.tangent, n = 0; n < i.length; n++) u = i[n], p = u.vertex, f = u.normalImpulse, m = u.tangentImpulse, 0 === f && 0 === m || (y.x = c.x * f + d.x * m, y.y = c.y * f + d.y * m, a.isStatic || a.isSleeping || (v = r.sub(p, a.position, g), a.positionPrev.x += y.x * a.inverseMass, a.positionPrev.y += y.y * a.inverseMass,
                ...
                o.collides = function(e, t, n) {
                    ...
                    for (var i, s, a = r._temp[0], l = r._temp[1], c = {
                        ...
                        if (s = n[d], o._projectToAxis(a, e, s), o._projectToAxis(l, t, s),
                            (i = Math.min(a.max - l.min, l.max - a.min)) <= 0) return c.overlap = i, c;
            ...
            ! function() {
                o.create = function(e, t) {
                    ...
                    for (l.update(h, x, b), l.removeOld(h, b), e.enableSleeping && r.afterCollisions(h.list, c.timeScale),
                        h.collisionStart.length > 0 && d.trigger(e, "collisionStart", {
                    ...
                    if ((0 !== t.x || 0 !== t.y) && 0 !== n)
                        for (var o = 0; o < e.length; o++) {
                            var i = e[o];
                            if (i.ignoreGravity==true) continue;
            ...
            ! function() {
                o.stack = function(e, t, n, o, r, s, l) {
                    ...
                    for (l = 0; l < n; l++) {
                        ...
                        if (l > 0)
                            for (c = 0; c < t; c++) d = f[c + (l - 1) * t], u = f[c + l * t], i.addConstraint(e, r.create(s.extend({
                                bodyA: d,
                                bodyB: u
                    ...
                    for (var a = [], l = 0; l < e.length; l++) {
                        ...
                        if (0 !== p) {
                            var f = i.normalise({
                                ...
                                h = n; - 1 === n && (h = 1.75 * Math.pow(p, .32)), h = r.clamp(h, o, s), h % 2 == 1 && (h += 1);
                            ...
                            if (r.render.visible && r.pointA && r.pointB) {
                                ...
                                if (s = l ? c.add(l.position, r.pointA) : r.pointA, "pin" === r.render.type) n.beginPath(), n.arc(s.x, s.y, 3, 0, 2 * Math.PI), n.closePath();
                                    ...
                                    if (a = d ? c.add(d.position, r.pointB) : r.pointB, n.beginPath(), n.moveTo(s.x, s.y), "spring" === r.render.type)
                                        for (var u, p = c.sub(a, s), f = c.perp(c.normalise(p)), m = Math.ceil(i.clamp(r.length / 5, 12, 20)), v = 1; v < m; v += 1) u = v % 2 == 0 ? 1 : -1,
                                ...
                                if (l.showAxes)
                                    for (r = d.length > 1 ? 1 : 0; r < d.length; r++)
                                        for (o = d[r], s = 0; s < o.axes.length; s++) {
                                            ...
                                            for (r = d.length > 1 ? 1 : 0; r < d.length; r++)
                                                for (o = d[r], s = 0; s < o.axes.length; s++) a.moveTo(o.position.x, o.position.y), a.lineTo((o.vertices[0].x + o.vertices[o.vertices.length - 1].x) / 2, (o.vertices[0].y + o.vertices[o.vertices.length - 1].y) / 2)
                        }
